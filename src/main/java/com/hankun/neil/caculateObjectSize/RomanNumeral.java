package com.hankun.neil.caculateObjectSize;
/**
 * 罗马数字
 * 字符：
 * 基本字符 I V X L C D M
        ...
        while (numberal > 0) {
            ...
            switch (baseNumberal * place) {
                case 0:
                    break;
                case 1:
                    stringValue.insert(0, "I");
                    break;
                case 2:
                    stringValue.insert(0, "II");
                    break;
                case 3:
                    stringValue.insert(0, "III");
                    break;
                case 4:
                    stringValue.insert(0, "IV");
                    break;
                case 5:
                    stringValue.insert(0, "V");
                    break;
                case 6:
                    stringValue.insert(0, "VI");
                    break;
                case 7:
                    stringValue.insert(0, "VII");
                    break;
                case 8:
                    stringValue.insert(0, "VIII");
                    break;
                case 9:
                    stringValue.insert(0, "IX");
                    break;
                case 10:
                    stringValue.insert(0, "X");
                    break;
                case 20:
                    stringValue.insert(0, "XX");
                    break;
                case 30:
                    stringValue.insert(0, "XXX");
                    break;
                case 40:
                    stringValue.insert(0, "XL");
                    break;
                case 50:
                    stringValue.insert(0, "L");
                    break;
                case 60:
                    stringValue.insert(0, "LX");
                    break;
                case 70:
                    stringValue.insert(0, "LXX");
                    break;
                case 80:
                    stringValue.insert(0, "LXXX");
                    break;
                case 90:
                    stringValue.insert(0, "XC");
                    break;
                case 100:
                    stringValue.insert(0, "C");
                    break;
                case 200:
                    stringValue.insert(0, "CC");
                    break;
                case 300:
                    stringValue.insert(0, "CCC");
                    break;
                case 400:
                    stringValue.insert(0, "CD");
                    break;
                case 500:
                    stringValue.insert(0, "D");
                    break;
                case 600:
                    stringValue.insert(0, "DC");
                    break;
                case 700:
                    stringValue.insert(0, "DCC");
                    break;
                case 800:
                    stringValue.insert(0, "DCCC");
                    break;
                case 900:
                    stringValue.insert(0, "CM");
                    break;
                case 1000:
                    stringValue.insert(0, "M");
                    break;
                case 2000:
                    stringValue.insert(0, "MM");
                    break;
                case 3000:
                    stringValue.insert(0, "MMM");
                    break;
                default:
                    throw new IllegalArgumentException("非法的罗马数字格式");
            }
